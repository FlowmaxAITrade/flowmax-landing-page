...
export const metadata: Metadata = createPageMetadata({ title: "使用条款｜FlowMax", description: "阅读 FlowMax 服务的使用条款，了解账户资格、用户行为、费用与服务变更等正式规则。本页面将在发布前完成法务审核。", path: "/legal/terms" });
