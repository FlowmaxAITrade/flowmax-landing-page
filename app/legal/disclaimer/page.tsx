...
export const metadata: Metadata = createPageMetadata({ title: "免责声明｜FlowMax", description: "阅读 FlowMax 的风险提示与免责声明，了解 AI 分析、策略信息和模拟验证的使用边界。投资与交易决策应由用户独立判断。", path: "/legal/disclaimer" });
