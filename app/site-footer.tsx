  ...
  return (
    <footer className="siteFooter">
      <div className="shell footerGrid">
        <div><Link className="brand" href="/"><span className="brandMark" aria-hidden="true"><Image className="brandMarkDark" src="/flowmax-logo-mark-dark.png" alt="" width={34} height={34} unoptimized /><Image className="brandMarkLight" src="/flowmax-logo-mark-light.png" alt="" width={34} height={34} unoptimized /></span><span className="brandName">Flowmax</span><Image className="brandWordmarkDark" src="/flowmax-wordmark-dark.png" alt="Flowmax" width={126} height={54} unoptimized /></Link><p>Build your AI analyst and strategy team.</p></div>
